...
export default function NewsNotifications() {
  const { items, add, update, remove } = useLocalCollection<Notification>('news:notifications', NOTIFICATION_SEED)
      ...
      <Card>
        ...
        <CardContent>
          <DataTable
            ...
            rowKey={(n) => n.id}
            pageSize={10}
            exportFilename="news-notifications"
            emptyIcon={<Bell className="w-6 h-6" />}
            emptyTitle="No notifications"
            emptyDescription="Create notifications for the news app."
            toolbar={
