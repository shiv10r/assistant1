...
export default function TravelCustomize() {
  ...
  if (submitted) return (
    <TravelShell>
      <div className="travel-main">
        <div className="travel-empty"><Sparkles aria-hidden="true" /><h2>Your trip request is ready</h2><p>A VSR travel specialist will contact you with itinerary options based on your dates and budget.</p><button type="button" onClick={() => setSubmitted(false)}>Plan another trip</button></div>
      </div>
    </TravelShell>
  )
  ...
  return (
    <TravelShell>
      <div className="travel-main">
        <div className="travel-page-head"><h1>Customize your trip</h1><p>Tell us what matters. We will shape the route, pace, stays, and experiences.</p></div>
