...
export default function TravelNotifications() {
  const { items, add, update, remove } = useLocalCollection<Notification>('travel:notifications', NOTIFICATION_SEED)
      ...
      <Card>
        ...
        <CardContent>
          <DataTable
            ...
            rowKey={(n) => n.id}
            pageSize={10}
            exportFilename="travel-notifications"
            emptyIcon={<Bell className="w-6 h-6" />}
            emptyTitle="No notifications"
            emptyDescription="Create notifications for the travel app."
            toolbar={
