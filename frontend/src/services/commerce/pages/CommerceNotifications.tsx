...
export default function CommerceNotifications() {
  const { items, add, update, remove } = useLocalCollection<Notification>('commerce:notifications', NOTIFICATION_SEED)
      ...
      <Card>
        ...
        <CardContent>
          <DataTable
            ...
            rowKey={(n) => n.id}
            pageSize={10}
            exportFilename="commerce-notifications"
            emptyIcon={<Bell className="w-6 h-6" />}
            emptyTitle="No notifications"
            emptyDescription="Create notifications for the commerce app."
            toolbar={
