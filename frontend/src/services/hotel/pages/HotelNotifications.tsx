...
export default function HotelNotifications() {
  const { items, add, update, remove } = useLocalCollection<Notification>('hotel:notifications', NOTIFICATION_SEED)
      ...
      <Card>
        ...
        <CardContent>
          <DataTable
            ...
            rowKey={(n) => n.id}
            pageSize={10}
            exportFilename="hotel-notifications"
            emptyIcon={<Bell className="w-6 h-6" />}
            emptyTitle="No notifications"
            emptyDescription="Create notifications for the hotel app."
            toolbar={
