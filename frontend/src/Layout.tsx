...
import {
  ...
  FiBuilding2,
  FiShoppingBag,
  FiCheckSquare as FiCheckSquare2,
  FiRotateCcw as FiRotateCcw2,
  FiSearch,
  FiUserPlus,
  FiBookOpen,
  FiCalendar,
  FiClock,
  FiArrowLeftRight as FiArrowLeftRight2,
  FiClipboardList as FiClipboardList2,
  FiBuilding2 as FiBuilding2_2,
  FiShoppingCart as FiShoppingCart2,
  FiListChecks,
  FiPackageCheck,
  FiRotateCcw as FiRotateCcw3,
  FiSearch as FiSearch2,
  FiUserPlus as FiUserPlus2,
  FiBookOpen as FiBookOpen2,
  FiCalendar as FiCalendar2,
  FiClock as FiClock2,
  FiArrowLeftRight as FiArrowLeftRight3,
  FiClipboardList as FiClipboardList3,
  FiBuilding2 as FiBuilding2_3,
  FiShoppingCart as FiShoppingCart3,
  FiListChecks as FiListChecks2,
  FiPackageCheck as FiPackageCheck2,
  FiRotateCcw as FiRotateCcw4,
  FiSearch as FiSearch3,
  FiUserPlus as FiUserPlus3,
  FiBookOpen as FiBookOpen3,
  FiCalendar as FiCalendar3,
  FiClock as FiClock3,
  FiArrowLeftRight as FiArrowLeftRight4,
  FiClipboardList as FiClipboardList4,
  FiBuilding2 as FiBuilding2_4,
  FiShoppingCart as FiShoppingCart4,
  FiListChecks as FiListChecks3,
  FiPackageCheck as FiPackageCheck2,
  FiRotateCcw as FiRotateCcw5,
  FiSearch as FiSearch4,
  FiUserPlus as FiUserPlus4,
  FiBookOpen as FiBookOpen4,
  FiCalendar as FiCalendar4,
  FiClock as FiClock4,
  FiArrowLeftRight as FiArrowLeftRight5,
  FiClipboardList as FiClipboardList5,
  FiBuilding2 as FiBuilding2_5,
  FiShoppingCart as FiShoppingCart5,
  FiListChecks as FiListChecks4,
  FiPackageCheck as FiPackageCheck3,
  FiRotateCcw as FiRotateCcw6,
  FiSearch as FiSearch5,
  FiUserPlus as FiUserPlus5,
  FiBookOpen as FiBookOpen5,
  FiCalendar as FiCalendar5,
  FiClock as FiClock5,
} from 'react-icons/fi'
import {
  MdDashboard,
...
import {
  ...
  BiClipboardList,
  BiBuildingHouse as BiBuildingHouse2,
...
const SERVICE_GROUPS: Record<ServiceId, NavGroup[]> = {
  interior: [
    { title: 'Interior Design', items: [
      ...
      { label: 'AI Designs', to: '/interior/projects', icon: <FiSparkles className="w-5 h-5" /> },
    ]},
  ...
  warehouse: [
    ...
    { title: 'Inventory', items: [
      ...
      { label: 'Warehouses & Locations', to: '/warehouse/warehouses', icon: <FiBuilding2 className="w-5 h-5" /> },
      { label: 'Purchase Orders', to: '/warehouse/purchase-orders', icon: <FiClipboardList className="w-5 h-5" /> },
      { label: 'Goods Received', to: '/warehouse/grn', icon: <FiTruck className="w-5 h-5" /> },
      { label: 'Stock Transfer', to: '/warehouse/transfers', icon: <FiArrowLeftRight className="w-5 h-5" /> },
      { label: 'Stock Count', to: '/warehouse/stock-count', icon: <FiCheckSquare className="w-5 h-5" /> },
      { label: 'Scan Barcode / QR', to: '/billing/items', icon: <FiQrCodeScanner className="w-5 h-5" /> },
    ]},
    { title: 'Outbound', items: [
      ...
      { label: 'Dispatch', to: '/warehouse/dispatch', icon: <FiTruck className="w-5 h-5" /> },
...
const COMMON_GROUPS: NavGroup[] = [
  ...
  { title: 'More', items: [
    { label: 'Broadcast', to: '/broadcast', icon: <FiMegaphone className="w-5 h-5" />, badge: 'PRO', premium: true },
  ...
  return (
    <div className="broadcast-ticker">
      <div className="broadcast-ticker-track">
        <span className="broadcast-ticker-item"><FiMegaphone className="w-4 h-4" /> {active.message}</span>
        <span className="broadcast-ticker-item"><FiMegaphone className="w-4 h-4" /> {active.message}</span>
        <span className="broadcast-ticker-item"><FiMegaphone className="w-4 h-4" /> {active.message}</span>
        <span className="broadcast-ticker-item"><FiMegaphone className="w-4 h-4" /> {active.message}</span>
      </div>
