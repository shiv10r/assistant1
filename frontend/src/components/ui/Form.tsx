  ...
  ({ className, variant = 'default', size = 'md', disabled, children, ...props }, ref) => (
    <button
      ...
      className={cn(
        ...
        {
          'bg-primary text-white hover:opacity-90 shadow-sm shadow-primary/30': variant === 'default',
          ...
          'bg-accent text-white hover:opacity-90 shadow-sm shadow-emerald-500/20': variant === 'success',
